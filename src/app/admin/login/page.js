...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center px-3 sm:px-4">
      <div className="w-full max-w-md">
        {/* Logo Section */}
        <div className="text-center mb-6 sm:mb-8">
          <div className="mx-auto flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full bg-white shadow-xl p-2 mb-3 sm:mb-4">
            <Image
              src="/logo.jpg"
              alt="Admin Logo"
              width={80}
          ...
          <p className="text-sm sm:text-base text-gray-600">Judging Tabulation System</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={() => setIsFocused('')}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg outline-none transition-all duration-200 text-sm sm:text-base text-black ${
                    emailError 
                ...
                {email && !emailError && (
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                    <svg className="w-4 sm:w-5 h-4 sm:h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={() => setIsFocused('')}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 sm:pr-12 border rounded-lg outline-none transition-all duration-200 text-sm sm:text-base text-black ${
                    passwordError 
                      ? 'border-red-300 bg-red-50 focus:ring-2 focus:ring-red-500 focus:border-red-500' 
                      : isFocused === 'password'
                      ? 'border-blue-500 bg-blue-50 ring-2 ring-blue-500 ring-opacity-20'
            ...
            {/* Error Message */}
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-3 sm:px-4 py-2 sm:py-3 rounded-lg flex items-start gap-2 animate-pulse">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group text-sm sm:text-base"
            >
